	...
	if(ACTION_NAME=="add")
	{
		echo(FormHelper::getTrsHtml($row_info,
			array(
				...
				array('zdcnf'=>array(
					array('zd'=>'class','type'=>'select','attr'=>'class="text"','param'=>array('list'=>$class_list,'vt'=>'val')),
					array('zd'=>'publish','type'=>'text','attr'=>'class="text"')
				)),
				array('zdcnf'=>array(
					array('zd'=>'fileformat','type'=>'text','attr'=>'class="text"'),
					array('zd'=>'keyword','type'=>'text','attr'=>'class="text"')
				)),
				array('zdcnf'=>array(
					array('zd'=>'mp3url','type'=>'file','attr'=>'class="file"','tdattr'=>'colspan="3"','after'=>'&nbsp;<span class="field_notice u-must">*</span>')
				)),
				array('zdcnf'=>array(
					array('zd'=>'txturl','type'=>'file','attr'=>'class="file"','tdattr'=>'colspan="3"','after'=>'&nbsp;<span class="field_notice u-must">*</span>')
				))
			)
	...
	else
	{
		echo(FormHelper::getTrsHtml($row_info,
			array(
				...
				array('zdcnf'=>array(
					array('zd'=>'mp3url','type'=>'file','attr'=>'class="text"','tdattr'=>'colspan="3"','before'=>'<a href="'.U('Index/showpic/book_id/'.$row_info['book_id']).'" target="_blank" class="u-btn u-btn-c5">'.L('view').'</a>&nbsp;')
				)),
				array('zdcnf'=>array(
					array('zd'=>'txturl','type'=>'file','attr'=>'class="text"','tdattr'=>'colspan="3"','before'=>'<a href="'.U('Index/show/book_id/'.$row_info['book_id']).'" target="_blank" class="u-btn u-btn-c5">'.L('view').'</a>&nbsp;')
				))
			)
