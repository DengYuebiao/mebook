...
&nbsp;<?php echo FormHelper::getSelectHtml($_GET['s2']?$_GET['s2']:'ip_beg',$zd_list,array('attr'=>'name="s2"')) ?>
&nbsp;<input type="text" name="v2" value="<?php echo $_GET['v2']?>" />
&nbsp;&nbsp;<input class="u-btn" type="submit" value="<?php echo L('search')?>" />
<a class="u-btn u-btn-c3" type="button" href="<?php echo U('Iplimit/add')?>"><?php echo L('add')?></a>
</form>
</div>
<!--搜索表单 end-->
<div class="m-data">
