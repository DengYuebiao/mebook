...
class ExportDataExcel extends ExportData {
	...
	{
		$this->sheet_index++;
		$sheet_str=" </Table></Worksheet><Worksheet ss:Name=\"Sheet{$this->sheet_index}\"><Table>";
		$this->write($sheet_str);
	}
}